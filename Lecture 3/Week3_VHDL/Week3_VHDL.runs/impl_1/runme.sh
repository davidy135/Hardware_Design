...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week3_VHDL/Week3_VHDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Week3_VHDL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Week3_VHDL.tcl -notrace
