...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week3_VHDL/Week3_VHDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Week3_VHDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Week3_VHDL.tcl
