...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week3_Verilog/Week3_Verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Week3Verilog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Week3Verilog.tcl
