...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week 4/Week4a/Week4a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Week4a.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Week4a.tcl
