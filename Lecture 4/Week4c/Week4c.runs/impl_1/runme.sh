...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week4c/Week4c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Week4c.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Week4c.tcl -notrace
