...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week4d/Week4d.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Week4d.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Week4d.tcl -notrace
