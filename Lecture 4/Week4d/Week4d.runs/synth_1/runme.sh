...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week4d/Week4d.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Week4d.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Week4d.tcl
