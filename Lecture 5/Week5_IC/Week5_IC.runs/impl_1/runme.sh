...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Week 5/Week5_IC/Week5_IC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IC_74138.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IC_74138.tcl -notrace
