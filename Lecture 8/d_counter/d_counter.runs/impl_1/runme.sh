...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Lecture 8/d_counter/d_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log d_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source d_counter.tcl -notrace
