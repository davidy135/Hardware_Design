...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Lecture 8/d_counter/d_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log d_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source d_counter.tcl
