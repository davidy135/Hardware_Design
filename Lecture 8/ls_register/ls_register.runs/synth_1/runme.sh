...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Lecture 8/ls_register/ls_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ls_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ls_register.tcl
