...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Lecture 8/t_counter/t_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log t_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source t_counter.tcl -notrace
