...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/Hardware Design/Lecture 8/t_counter/t_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log t_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source t_counter.tcl
