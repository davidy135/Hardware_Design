...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.UART_USB \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../UART_USB.srcs/sources_1/bd/UART_USB/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../UART_USB.srcs/sources_1/bd/UART_USB/ipshared/8c62/hdl" \
       +incdir+"../../../../UART_USB.srcs/sources_1/bd/UART_USB/ipshared/ec67/hdl" \
       +incdir+"../../../../UART_USB.srcs/sources_1/bd/UART_USB/ipshared/8c62/hdl" \
       +incdir+"../../../../UART_USB.srcs/sources_1/bd/UART_USB/ip/UART_USB_processing_system7_0_0" \
