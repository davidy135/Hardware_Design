...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/UART_USB/UART_USB.runs/UART_USB_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_USB_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_USB_xbar_0.tcl
