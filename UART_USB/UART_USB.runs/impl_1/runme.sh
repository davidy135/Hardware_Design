...
HD_PWD='/afs/ee.cooper.edu/user/d/david.yang/UART_USB/UART_USB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_USB_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_USB_wrapper.tcl -notrace
