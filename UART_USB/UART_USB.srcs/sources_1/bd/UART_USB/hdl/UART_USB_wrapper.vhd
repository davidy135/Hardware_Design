...
end UART_USB_wrapper;

architecture STRUCTURE of UART_USB_wrapper is
  component UART_USB is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component UART_USB;
begin
UART_USB_i: component UART_USB
     port map (
